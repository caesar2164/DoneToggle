module.exports = function (grunt) {
    ...
    var directoryPackage = './DoneToggle';
    ...
    grunt.initConfig({
        ...
        htmlmin: {
            all: {
                ...
                files: {
                    'DoneToggle/public/edit.html': directoryPrivate + '/edit.html',
                    'DoneToggle/public/view.html': directoryPrivate + '/view.html',
                },
            },
        },
        jshint: {
        ...
        less: {
            view: {
                options: {
                    sourceMap: true,
                    sourceMapFilename: 'DoneToggle/public/view.less.min.css.map',
                    outputSourceFiles: true,
                    cleancss: true,
                    compress: true,
                },
                files: {
                    'DoneToggle/public/view.less.min.css':
            ...
            edit: {
                options: {
                    sourceMap: true,
                    sourceMapFilename: 'DoneToggle/public/edit.less.min.css.map',
                    outputSourceFiles: true,
                    cleancss: true,
                    compress: true,
                },
                files: {
                    'DoneToggle/public/edit.less.min.css':
